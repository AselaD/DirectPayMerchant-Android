...
public class BillPaymentCategoryAcitivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bill_payment_category_acitivity);
        ...
        try {
            ...
            //JSONObject firstObject = categoryList.getJSONObject(0);
            // JSONArray mobile = firstObject.getJSONArray("Mobile");
            Log.d("Category", categoryList.toString());
            Log.d("DUMMYDATA", DummyData.dummyData.toString());
            //  Log.d("MOBILE", mobile.toString());

            if(buttonText.equals("Billers")) {
                for (int i = 0; i < categoryList.length(); i++) {
                    JSONObject object = categoryList.optJSONObject(i);
                    ...
                    while (iterator.hasNext()) {
                        ...
                        button.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View view) {
                                Intent intent = new Intent(BillPaymentCategoryAcitivity.this, MobileActivity.class);
                                intent.putExtra(BUTTON_TEXT, button.getText());
                                startActivity(intent);
                                Log.d(BUTTON_TEXT, button.getText().toString());
                                //finish();
           ...
           /* if(buttonTextTwo.equals("Other Services")) {
                for (int noOfCategories = 0; noOfCategories < categoryList.length(); noOfCategories++) {
                    ...
                    for (int i = 0; i < name.length(); i++) {
                        ...
                        JSONArray otherName = otherObject.getJSONArray("Other Services");
